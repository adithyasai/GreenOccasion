export default function NorthStarSection() {
  return (
    <section id="north-star" className="py-24 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center space-x-8 bg-white rounded-2xl px-12 py-8 shadow-lg">
            <div className="text-center">
              <div className="text-4xl font-bold text-teal-600">100%</div>
              <div className="text-sm text-gray-600 mt-1">Volunteer-Driven</div>
            </div>
            <div className="w-px h-12 bg-gray-300"></div>
            <div className="text-center">
              <div className="text-4xl font-bold text-teal-600">Open</div>
              <div className="text-sm text-gray-600 mt-1">Source Standards</div>
            </div>
            <div className="w-px h-12 bg-gray-300"></div>
            <div className="text-center">
              <div className="text-4xl font-bold text-teal-600">Global</div>
              <div className="text-sm text-gray-600 mt-1">Impact Focus</div>
            </div>
          </div>
        </div>
      </div>
